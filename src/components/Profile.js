...
const Profile = () => {
    ...
    const [profileInfo, setProfileInfo] = useState({
        ...
        phoneNumber: '',
        collegeName: '',
        photoURL: 'https://www.pngmart.com/files/22/User-Avatar-Profile-Background-Isolated-PNG.png', // Default photo for guest users
    });
        ...
        const unsubscribe = onAuthStateChanged(auth, async (currentUser) => {
            if (currentUser) {
                ...
                if (currentUser.isAnonymous) {
                    ...
                    setTestResults([]); // Guest users won't have test results saved
                } else {

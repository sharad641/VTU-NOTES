  ...
  const subjectsData = {
    ...
    cse: {
      ...
      6: [
        ...
        { name:'CLOUD COMPUTING', code: 'BCS601,BIS613D', credits: 4, info: '' },
       ...
       7: [
        { name:'MACHINE LEARNING', code: 'BIC703', credits: 4, info: '' },
        { name:'BIG DATA ANALYTICS', code: 'BCS714D', credits: 4, info: '' },

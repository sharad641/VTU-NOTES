      ...
      <div className="subjects-container">
        ...
        <div className="subjects-header">
          <div className="header-badge">
            <span className="badge-text">{branch?.toUpperCase()} Stream</span>
          </div>
          <h1 className="header-title">Semester {semester} Resources</h1>
          <p className="header-subtitle">
            Curated notes, question papers, and lab manuals for your syllabus.
          </p>
        </div>
        ...
        <div className="subjects-grid">
          {subjects.length > 0 ? (
            subjects.map((subject, index) => (
              <React.Fragment key={`${subject.code}-${index}`}>
                ...
                >
                  ...
                  <div className="card-body">
                    ...
                    <p className="subject-desc">
                      {subject.info || "Access comprehensive study materials including notes and model papers."}
                    </p>
                  </div>

                  <div className="card-footer">
                    <span className="btn-label">Open Modules</span>
                ...
                {(index + 1) % 3 === 0 && (
                  <div 
                    className="ad-card animate-card"
            ...
            <div className="empty-state-wrapper">
              ...
              <p>We are still curating quality content for {branch?.toUpperCase()} Semester {semester}.</p>

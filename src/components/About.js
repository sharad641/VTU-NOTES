          ...
          <div className="donation-options">
            ...
            <ul>
              <li>
                ...
                <a 
                  href="upi://pay?pa=6364060716@ptyes&pn=VTU%20Notes&am=300&cu=INR"
                  className="link"
                >
                  6364060716@ptyes (Pay ₹300)
                </a>
              </li>
              <li>
                <strong>PhonePe UPI:</strong>{" "}
                <a 
                  href="upi://pay?pa=6364060716@axl&pn=VTU%20Notes&am=300&cu=INR"
                  className="link"
                >
                  6364060716@axl (Pay ₹300)
                </a>
              </li>
            </ul>
          </div>

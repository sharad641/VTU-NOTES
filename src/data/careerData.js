export const careerArticles = [
  ...
  },
  {
    ...
    cpcLevel: "High",
    imageUrl: "/assets/career/laptop-guide.png",
    takeaways: [
      "Minimum Specs: i5/Ryzen 5, 16GB RAM, 512GB SSD.",
      "CSE/IT students prioritize RAM and CPU over GPU.",
      "Mechanical/Civil students need a dedicated GPU for CAD.",
      "Don't buy a gaming laptop if you need battery life."
    ],
    summary: "From online classes and coding to final-year projects, simulations, and internships, the right laptop directly impacts your learning speed and career growth.",
    keywords: ["Engineering Laptops", "Student Deals", "Programming", "CAD/SolidWorks"],
